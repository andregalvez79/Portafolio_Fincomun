...
reg.rf_m2=randomForest(porcentajeM2 ~ porcentajeM1+OtrosProductos + Credinomina + Especiales 
...
pred.rf_m2 <- predict(reg.rf_m2, Mesesp, predict.all=TRUE)
...
write.csv(pred_rf_m2,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\pred_rf1_m2.csv")
...
write.csv(pred_rf_m2_ama,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\pred_rf_m2_ama.csv")
...
reg.rf_m3=randomForest(porcentajeM3 ~ porcentajeM1+ porcentajeM2 +OtrosProductos + Credinomina + Especiales 
                    + NuevoProd + Nvo_Alcancia +
                      Nvo_Credinom + Nvo_Efec + Nvo_MiTienda + Nvo_Otros +
                      Recomp_Aut_crediv + Recomp_Aut_MiTienda + Recomp_Aut_prod +
                      Redoc_no_Aut_Efec + Redoc_no_Aut_MiTienda + 
...
#PREDICCIONES
#para todas las predicciones
pred.rf_m3 <- predict(reg.rf_m3, Mesesp, predict.all=TRUE)
...
write.csv(pred_rf_m3,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\pred_rf1_m3.csv")
...
write.csv(pred_rf_m3_ama,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\pred_rf_m3_ama.csv")
