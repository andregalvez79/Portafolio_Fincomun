...
##RF
reg.rf=randomForest(porcentajeM1 ~ NuevoProd + Nvo_Alcancia +
...
predValid <- predict(reg.rf, MesesPrue, type = "response")
# Checking classification accuracy
...
pred.rf <- predict(reg.rf, MesesPrue, predict.all=TRUE)
...
write.csv(pred_rf,"C:/Users/andrevargas/Documents/Modelo_mora/Modelos_redes/pred_nuevos_limite_superior.csv")
...
write.csv(pred_rf_ama,"C:/Users/andrevargas/Documents/Modelo_mora/Modelos_redes/pred_nuevos_alerta_amarilla.csv")
...
write.csv(pred_rf_ama2,"C:/Users/andrevargas/Documents/Modelo_mora/Modelos_redes/pred_nuevos_alerta_amarilla2.csv")



######PLOT resultados

Pl<-read.csv("C:/Users/andrevargas/Documents/Modelo_mora/Modelos_redes/plot_nuevos.csv", stringsAsFactors = F)
str(Pl)
...
#plot mes2
Pl2<-read.csv("C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Modelos_redes\\plot_nuevos_m2.csv", stringsAsFactors = F)
str(Pl2)
#Pl2 <-Pl2[-58,]
