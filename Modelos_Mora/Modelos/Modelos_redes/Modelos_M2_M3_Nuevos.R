...
Meses <- read.csv("C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Crear_Bases\\Redes_Suc\\BaseCosechas\\Base.CM.Nuevos.csv")
...
colnames(Meses)[20] <- "Oriente"

########### train


sample = sample.split(Meses$porcentajeM2, SplitRatio = .80)
MesesPrueba <- subset(Meses, sample == TRUE)
MesesTrain <- subset(Meses, sample == FALSE)


##Mes 2
reg.rf_m2=randomForest(porcentajeM2 ~ porcentajeM1 + NuevoProd + Nvo_Alcancia +
                         Nvo_Efec + Nvo_MiTienda  +
                         Mto_Desembolso + 
                         Asesor + FzaMovil + Intermediario + Promotor +
...
write.csv(pred_rf_m2,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Modelos_redes\\pred_nuevos_m2.csv")
...
write.csv(pred_rf_m2_ama,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Modelos_redes\\pred_nuevos_m2_ama.csv")
...
write.csv(pred_rf_m2_ama2,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Modelos_redes\\pred_nuevos_m2_ama2.csv")

#############################################
sample = sample.split(Meses$porcentajeM3, SplitRatio = .80)
MesesPrueba <- subset(Meses, sample == TRUE)
MesesTrain <- subset(Meses, sample == FALSE)

#####Mes 3

reg.rf_m3=randomForest(porcentajeM3 ~ porcentajeM1+ porcentajeM2 + NuevoProd + Nvo_Alcancia +
                         Nvo_Efec + Nvo_MiTienda  +
                         Mto_Desembolso + 
                         Asesor + FzaMovil + Intermediario + Promotor +
                         Unificacion + SinRes  + Reestructuracion + OtroTer+
...
write.csv(pred_rf_m3,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Modelos_redes\\pred_nuevos_m3.csv")
...
write.csv(pred_rf_m3_ama,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Modelos_redes\\pred_nuevos_m3_ama.csv")
...
write.csv(pred_rf_ama2,"C:\\Users\\andrevargas\\Documents\\Modelo_mora\\Modelos_redes\\pred_nuevos_m3_ama2.csv")
