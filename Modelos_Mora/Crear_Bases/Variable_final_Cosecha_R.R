...
mora <- read.csv("C:/Users/xiaoping/Desktop/Nueva carpeta/cosechas_redes_recomp.csv", 
                 stringsAsFactors = F)
...
# write.csv(C, "C:/Users/xiaoping/Desktop/Nueva carpeta/Base.CM.Recomp.csv")
